...
const sc_logic Y::ap_const_logic_1 = sc_dt::Log_1;
const sc_logic Y::ap_const_logic_0 = sc_dt::Log_0;
const sc_lv<27> Y::ap_ST_fsm_state1 = "1";
const sc_lv<27> Y::ap_ST_fsm_state2 = "10";
const sc_lv<27> Y::ap_ST_fsm_state3 = "100";
const sc_lv<27> Y::ap_ST_fsm_state4 = "1000";
const sc_lv<27> Y::ap_ST_fsm_state5 = "10000";
const sc_lv<27> Y::ap_ST_fsm_state6 = "100000";
const sc_lv<27> Y::ap_ST_fsm_state7 = "1000000";
const sc_lv<27> Y::ap_ST_fsm_state8 = "10000000";
const sc_lv<27> Y::ap_ST_fsm_state9 = "100000000";
const sc_lv<27> Y::ap_ST_fsm_state10 = "1000000000";
const sc_lv<27> Y::ap_ST_fsm_state11 = "10000000000";
const sc_lv<27> Y::ap_ST_fsm_state12 = "100000000000";
const sc_lv<27> Y::ap_ST_fsm_state13 = "1000000000000";
const sc_lv<27> Y::ap_ST_fsm_state14 = "10000000000000";
const sc_lv<27> Y::ap_ST_fsm_state15 = "100000000000000";
const sc_lv<27> Y::ap_ST_fsm_state16 = "1000000000000000";
const sc_lv<27> Y::ap_ST_fsm_state17 = "10000000000000000";
const sc_lv<27> Y::ap_ST_fsm_state18 = "100000000000000000";
const sc_lv<27> Y::ap_ST_fsm_state19 = "1000000000000000000";
const sc_lv<27> Y::ap_ST_fsm_state20 = "10000000000000000000";
const sc_lv<27> Y::ap_ST_fsm_state21 = "100000000000000000000";
const sc_lv<27> Y::ap_ST_fsm_state22 = "1000000000000000000000";
const sc_lv<27> Y::ap_ST_fsm_state23 = "10000000000000000000000";
const sc_lv<27> Y::ap_ST_fsm_state24 = "100000000000000000000000";
const sc_lv<27> Y::ap_ST_fsm_state25 = "1000000000000000000000000";
const sc_lv<27> Y::ap_ST_fsm_state26 = "10000000000000000000000000";
const sc_lv<27> Y::ap_ST_fsm_state27 = "100000000000000000000000000";
const sc_lv<32> Y::ap_const_lv32_0 = "00000000000000000000000000000000";
const sc_lv<32> Y::ap_const_lv32_5 = "101";
const sc_lv<1> Y::ap_const_lv1_0 = "0";
const sc_lv<32> Y::ap_const_lv32_A = "1010";
const sc_lv<32> Y::ap_const_lv32_F = "1111";
const sc_lv<32> Y::ap_const_lv32_14 = "10100";
const sc_lv<32> Y::ap_const_lv32_1 = "1";
const sc_lv<32> Y::ap_const_lv32_6 = "110";
const sc_lv<32> Y::ap_const_lv32_19 = "11001";
const sc_lv<64> Y::ap_const_lv64_4030000000000000 = "100000000110000000000000000000000000000000000000000000000000000";
const sc_lv<32> Y::ap_const_lv32_B = "1011";
const sc_lv<32> Y::ap_const_lv32_10 = "10000";
const sc_lv<32> Y::ap_const_lv32_15 = "10101";
const sc_lv<64> Y::ap_const_lv64_3FD072B020C49BA6 = "11111111010000011100101011000000100000110001001001101110100110";
const sc_lv<64> Y::ap_const_lv64_3FB916872B020C4A = "11111110111001000101101000011100101011000000100000110001001010";
const sc_lv<64> Y::ap_const_lv64_3FE020C49BA5E354 = "11111111100000001000001100010010011011101001011110001101010100";
const sc_lv<8> Y::ap_const_lv8_42 = "1000010";
const sc_lv<8> Y::ap_const_lv8_1A = "11010";
const sc_lv<8> Y::ap_const_lv8_4C = "1001100";
const sc_lv<8> Y::ap_const_lv8_24 = "100100";
const sc_lv<8> Y::ap_const_lv8_55 = "1010101";
const sc_lv<8> Y::ap_const_lv8_2D = "101101";
const sc_lv<32> Y::ap_const_lv32_34 = "110100";
const sc_lv<32> Y::ap_const_lv32_3E = "111110";
const sc_lv<1> Y::ap_const_lv1_1 = "1";
const sc_lv<32> Y::ap_const_lv32_1A = "11010";
const sc_lv<12> Y::ap_const_lv12_C01 = "110000000001";
const sc_lv<11> Y::ap_const_lv11_3FF = "1111111111";
const sc_lv<32> Y::ap_const_lv32_35 = "110101";
const sc_lv<32> Y::ap_const_lv32_3C = "111100";
const sc_lv<8> Y::ap_const_lv8_3E = "111110";
const bool Y::ap_const_boolean_1 = true;

Y::Y(sc_module_name name) : sc_module(name), mVcdFile(0) {
    Y_dadd_64ns_64ns_bkb_U1 = new Y_dadd_64ns_64ns_bkb<1,5,64,64,64>("Y_dadd_64ns_64ns_bkb_U1");
    Y_dadd_64ns_64ns_bkb_U1->clk(ap_clk);
    Y_dadd_64ns_64ns_bkb_U1->reset(ap_rst);
    Y_dadd_64ns_64ns_bkb_U1->din0(grp_fu_84_p0);
    Y_dadd_64ns_64ns_bkb_U1->din1(grp_fu_84_p1);
    Y_dadd_64ns_64ns_bkb_U1->ce(ap_var_for_const0);
    Y_dadd_64ns_64ns_bkb_U1->dout(grp_fu_84_p2);
    Y_dmul_64ns_64ns_cud_U2 = new Y_dmul_64ns_64ns_cud<1,5,64,64,64>("Y_dmul_64ns_64ns_cud_U2");
    Y_dmul_64ns_64ns_cud_U2->clk(ap_clk);
    Y_dmul_64ns_64ns_cud_U2->reset(ap_rst);
    Y_dmul_64ns_64ns_cud_U2->din0(reg_106);
    Y_dmul_64ns_64ns_cud_U2->din1(grp_fu_89_p1);
    Y_dmul_64ns_64ns_cud_U2->ce(ap_var_for_const0);
    Y_dmul_64ns_64ns_cud_U2->dout(grp_fu_89_p2);
    Y_dmul_64ns_64ns_cud_U3 = new Y_dmul_64ns_64ns_cud<1,5,64,64,64>("Y_dmul_64ns_64ns_cud_U3");
    Y_dmul_64ns_64ns_cud_U3->clk(ap_clk);
    Y_dmul_64ns_64ns_cud_U3->reset(ap_rst);
    Y_dmul_64ns_64ns_cud_U3->din0(tmp_4_reg_356);
    Y_dmul_64ns_64ns_cud_U3->din1(ap_var_for_const1);
    Y_dmul_64ns_64ns_cud_U3->ce(ap_var_for_const0);
    Y_dmul_64ns_64ns_cud_U3->dout(grp_fu_94_p2);
    Y_sitodp_32ns_64_dEe_U4 = new Y_sitodp_32ns_64_dEe<1,5,32,64>("Y_sitodp_32ns_64_dEe_U4");
    Y_sitodp_32ns_64_dEe_U4->clk(ap_clk);
    Y_sitodp_32ns_64_dEe_U4->reset(ap_rst);
    Y_sitodp_32ns_64_dEe_U4->din0(grp_fu_100_p0);
    Y_sitodp_32ns_64_dEe_U4->ce(ap_var_for_const0);
    Y_sitodp_32ns_64_dEe_U4->dout(grp_fu_100_p1);
    Y_sitodp_32ns_64_dEe_U5 = new Y_sitodp_32ns_64_dEe<1,5,32,64>("Y_sitodp_32ns_64_dEe_U5");
    Y_sitodp_32ns_64_dEe_U5->clk(ap_clk);
    Y_sitodp_32ns_64_dEe_U5->reset(ap_rst);
    Y_sitodp_32ns_64_dEe_U5->din0(grp_fu_103_p0);
    Y_sitodp_32ns_64_dEe_U5->ce(ap_var_for_const0);
    Y_sitodp_32ns_64_dEe_U5->dout(grp_fu_103_p1);
    ...
    SC_METHOD(thread_zext_ln15_fu_188_p1);
    sensitive << ( R );
    ...
    apTFilenSS << "Y_sc_trace_" << apTFileNum ++;
    ...
    sc_trace(mVcdFile, zext_ln15_fu_188_p1, "zext_ln15_fu_188_p1");
    ...
    mHdltvinHandle.open("Y.hdltvin.dat");
    mHdltvoutHandle.open("Y.hdltvout.dat");
}
...
Y::~Y() {
    ...
    delete Y_dadd_64ns_64ns_bkb_U1;
    delete Y_dmul_64ns_64ns_cud_U2;
    delete Y_dmul_64ns_64ns_cud_U3;
    delete Y_sitodp_32ns_64_dEe_U4;
    delete Y_sitodp_32ns_64_dEe_U5;
}

void Y::thread_ap_var_for_const0() {
    ap_var_for_const0 = ap_const_logic_1;
}

void Y::thread_ap_var_for_const1() {
    ap_var_for_const1 = ap_const_lv64_3FE020C49BA5E354;
}

void Y::thread_ap_clk_no_reset_() {
...
void Y::thread_add_ln502_fu_234_p2() {
...
void Y::thread_and_ln10_1_fu_164_p2() {
    and_ln10_1_fu_164_p2 = (and_ln10_fu_158_p2.read() & icmp_ln10_fu_122_p2.read());
}

void Y::thread_and_ln10_2_fu_170_p2() {
    and_ln10_2_fu_170_p2 = (icmp_ln10_4_fu_146_p2.read() & icmp_ln10_5_fu_152_p2.read());
}

void Y::thread_and_ln10_3_fu_176_p2() {
    and_ln10_3_fu_176_p2 = (and_ln10_2_fu_170_p2.read() & icmp_ln10_3_fu_140_p2.read());
}

void Y::thread_and_ln10_4_fu_182_p2() {
    and_ln10_4_fu_182_p2 = (and_ln10_3_fu_176_p2.read() & and_ln10_1_fu_164_p2.read());
}

void Y::thread_and_ln10_fu_158_p2() {
    and_ln10_fu_158_p2 = (icmp_ln10_1_fu_128_p2.read() & icmp_ln10_2_fu_134_p2.read());
}

void Y::thread_ap_CS_fsm_state1() {
    ap_CS_fsm_state1 = ap_CS_fsm.read()[0];
}

void Y::thread_ap_CS_fsm_state11() {
    ap_CS_fsm_state11 = ap_CS_fsm.read()[10];
}

void Y::thread_ap_CS_fsm_state12() {
    ap_CS_fsm_state12 = ap_CS_fsm.read()[11];
}

void Y::thread_ap_CS_fsm_state16() {
    ap_CS_fsm_state16 = ap_CS_fsm.read()[15];
}

void Y::thread_ap_CS_fsm_state17() {
    ap_CS_fsm_state17 = ap_CS_fsm.read()[16];
}

void Y::thread_ap_CS_fsm_state2() {
    ap_CS_fsm_state2 = ap_CS_fsm.read()[1];
}

void Y::thread_ap_CS_fsm_state21() {
    ap_CS_fsm_state21 = ap_CS_fsm.read()[20];
}

void Y::thread_ap_CS_fsm_state22() {
    ap_CS_fsm_state22 = ap_CS_fsm.read()[21];
}

void Y::thread_ap_CS_fsm_state26() {
    ap_CS_fsm_state26 = ap_CS_fsm.read()[25];
}

void Y::thread_ap_CS_fsm_state27() {
    ap_CS_fsm_state27 = ap_CS_fsm.read()[26];
}

void Y::thread_ap_CS_fsm_state6() {
    ap_CS_fsm_state6 = ap_CS_fsm.read()[5];
}

void Y::thread_ap_CS_fsm_state7() {
    ap_CS_fsm_state7 = ap_CS_fsm.read()[6];
}

void Y::thread_ap_done() {
...
void Y::thread_ap_return() {
    ap_return = (!and_ln10_4_reg_341.read()[0].is_01())? sc_lv<8>(): ((and_ln10_4_reg_341.read()[0].to_bool())? ap_const_lv8_3E: val_V_fu_311_p3.read());
}

void Y::thread_grp_fu_100_p0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state7.read())) {
        grp_fu_100_p0 = zext_ln15_2_fu_196_p1.read();
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read())) {
        grp_fu_100_p0 = zext_ln15_fu_188_p1.read();
    } else {
        grp_fu_100_p0 = "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX";
    }
}

void Y::thread_grp_fu_103_p0() {
    grp_fu_103_p0 = esl_zext<32,8>(G.read());
}

void Y::thread_grp_fu_84_p0() {
...
void Y::thread_zext_ln1285_fu_273_p1() {
    zext_ln1285_fu_273_p1 = esl_zext<54,32>(sext_ln1311_1_fu_265_p1.read());
}

void Y::thread_zext_ln1287_fu_269_p1() {
    zext_ln1287_fu_269_p1 = esl_zext<113,32>(sext_ln1311_1_fu_265_p1.read());
}

void Y::thread_zext_ln15_2_fu_196_p1() {
    zext_ln15_2_fu_196_p1 = esl_zext<32,8>(B.read());
}

void Y::thread_zext_ln15_fu_188_p1() {
    zext_ln15_fu_188_p1 = esl_zext<32,8>(R.read());
}

void Y::thread_zext_ln502_fu_231_p1() {
    zext_ln502_fu_231_p1 = esl_zext<12,11>(tmp_V_reg_371.read());
}

void Y::thread_zext_ln662_fu_297_p1() {
    zext_ln662_fu_297_p1 = esl_zext<8,1>(tmp_10_fu_289_p3.read());
}

void Y::thread_zext_ln682_fu_227_p1() {
    zext_ln682_fu_227_p1 = esl_zext<113,54>(mantissa_V_fu_218_p4.read());
}

void Y::thread_ap_NS_fsm() {
