...
unsigned char Cb( char llvm_cbe_R,  char llvm_cbe_G,  char llvm_cbe_B);
...
printf("\n\{ BEGIN @Cb\n");
if (AESL_DEBUG_TRACE)
printf("\n  %%or.cond4 = and i1 %%1, %%2, !dbg !2 for 0x%I64xth hint within @Cb  --> \n", ++aesl_llvm_cbe_or_2e_cond4_count);
...
llvm_cbe_tmp__14:
if (AESL_DEBUG_TRACE)
printf("\n  %%or.cond = and i1 %%4, %%5, !dbg !2 for 0x%I64xth hint within @Cb  --> \n", ++aesl_llvm_cbe_or_2e_cond_count);
...
llvm_cbe_tmp__16:
if (AESL_DEBUG_TRACE)
printf("\n  %%or.cond3 = and i1 %%7, %%8, !dbg !2 for 0x%I64xth hint within @Cb  --> \n", ++aesl_llvm_cbe_or_2e_cond3_count);
...
llvm_cbe_tmp__17:
if (AESL_DEBUG_TRACE)
printf("\n  %%storemerge = phi i8 [ %%22, %%9 ], [ -123, %%6  for 0x%I64xth hint within @Cb  --> \n", ++aesl_llvm_cbe_storemerge_count);
