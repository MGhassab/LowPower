...
// ==============================================================
#ifndef __Cb_dadddsub_64ns_bkb__HH__
#define __Cb_dadddsub_64ns_bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Cb_dadddsub_64ns_bkb) {
    ...
    SC_CTOR(Cb_dadddsub_64ns_bkb):  ACMP_dadddsub_U ("ACMP_dadddsub_U") {
