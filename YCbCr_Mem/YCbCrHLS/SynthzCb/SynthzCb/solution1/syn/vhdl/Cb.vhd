...
architecture behav of Cb is 
    ...
    "Cb,hls_ip_2019_1,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7s100-fgga676-2,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.567000,HLS_SYN_LAT=26,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=25,HLS_SYN_FF=2140,HLS_SYN_LUT=2977,HLS_VERSION=2019_1}";
    ...
    constant ap_const_lv64_BFC2F1A9FBE76C8B : STD_LOGIC_VECTOR (63 downto 0) := "1011111111000010111100011010100111111011111001110110110010001011";
    ...
    constant ap_const_lv64_3FD29FBE76C8B439 : STD_LOGIC_VECTOR (63 downto 0) := "0011111111010010100111111011111001110110110010001011010000111001";
    ...
    component Cb_dadddsub_64ns_bkb IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component Cb_dmul_64ns_64nscud IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component Cb_sitodp_32ns_64dEe IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
...
begin
    Cb_dadddsub_64ns_bkb_U1 : component Cb_dadddsub_64ns_bkb
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 64,
    ...
    Cb_dmul_64ns_64nscud_U2 : component Cb_dmul_64ns_64nscud
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 64,
    ...
    Cb_dmul_64ns_64nscud_U3 : component Cb_dmul_64ns_64nscud
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 64,
    ...
    port map (
        ...
        reset => ap_rst,
        din0 => tmp_4_reg_356,
        din1 => ap_const_lv64_3FD29FBE76C8B439,
        ce => ap_const_logic_1,
        dout => grp_fu_94_p2);

    Cb_sitodp_32ns_64dEe_U4 : component Cb_sitodp_32ns_64dEe
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 32,
    ...
    Cb_sitodp_32ns_64dEe_U5 : component Cb_sitodp_32ns_64dEe
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 32,
    ...
    ap_return <= 
        ap_const_lv8_85 when (and_ln10_4_reg_341(0) = '1') else 
        val_V_fu_311_p3;

    grp_fu_100_p0_assign_proc : process(zext_ln16_fu_188_p1, ap_CS_fsm_state2, zext_ln16_2_fu_196_p1, ap_CS_fsm_state7)
    begin
    ...
    begin
        if (((ap_const_lv1_0 = and_ln10_4_reg_341) and (ap_const_logic_1 = ap_CS_fsm_state12))) then 
            grp_fu_84_opcode <= ap_const_lv2_1;
        elsif ((((ap_const_lv1_0 = and_ln10_4_reg_341) and (ap_const_logic_1 = ap_CS_fsm_state22)) or ((ap_const_lv1_0 = and_ln10_4_reg_341) and (ap_const_logic_1 = ap_CS_fsm_state17)))) then 
    ...
    zext_ln16_2_fu_196_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(B),32));
    zext_ln16_fu_188_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(R),32));
