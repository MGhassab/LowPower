...
// ==============================================================
#ifndef __Cr_dadddsub_64ns_bkb__HH__
#define __Cr_dadddsub_64ns_bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Cr_dadddsub_64ns_bkb) {
    ...
    SC_CTOR(Cr_dadddsub_64ns_bkb):  ACMP_dadddsub_U ("ACMP_dadddsub_U") {
