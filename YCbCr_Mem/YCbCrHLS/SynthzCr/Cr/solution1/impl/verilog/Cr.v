...
wire   [31:0] zext_ln17_fu_188_p1;
wire    ap_CS_fsm_state2;
wire   [63:0] grp_fu_103_p1;
reg   [63:0] tmp_4_reg_356;
wire   [31:0] zext_ln17_2_fu_196_p1;
...
Cr_dadddsub_64ns_bkb #(
    .ID( 1 ),
    .NUM_STAGE( 5 ),
    .din0_WIDTH( 64 ),
    .din1_WIDTH( 64 ),
    .dout_WIDTH( 64 ))
Cr_dadddsub_64ns_bkb_U1(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_84_p0),
    .din1(grp_fu_84_p1),
...
Cr_dmul_64ns_64nscud #(
    .ID( 1 ),
    .NUM_STAGE( 5 ),
    .din0_WIDTH( 64 ),
    .din1_WIDTH( 64 ),
    .dout_WIDTH( 64 ))
Cr_dmul_64ns_64nscud_U2(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(reg_106),
    .din1(grp_fu_89_p1),
...
Cr_dmul_64ns_64nscud #(
    ...
    .din1_WIDTH( 64 ),
    .dout_WIDTH( 64 ))
Cr_dmul_64ns_64nscud_U3(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(tmp_4_reg_356),
    .din1(64'd4600300918569395290),
    .ce(1'b1),
    .dout(grp_fu_94_p2)
);

Cr_sitodp_32ns_64dEe #(
    .ID( 1 ),
    .NUM_STAGE( 5 ),
    .din0_WIDTH( 32 ),
    .dout_WIDTH( 64 ))
Cr_sitodp_32ns_64dEe_U4(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_100_p0),
    .ce(1'b1),
...
always @ (*) begin
    if ((((1'd0 == and_ln10_4_reg_341) & (1'b1 == ap_CS_fsm_state17)) | ((1'd0 == and_ln10_4_reg_341) & (1'b1 == ap_CS_fsm_state12)))) begin
        grp_fu_84_opcode = 2'd1;
    end else if (((1'd0 == and_ln10_4_reg_341) & (1'b1 == ap_CS_fsm_state22))) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state12)) begin
        grp_fu_89_p1 = 64'd4589780509839857811;
...
assign ap_return = ((and_ln10_4_reg_341[0:0] === 1'b1) ? 8'd123 : val_V_fu_311_p3);
...
assign zext_ln17_2_fu_196_p1 = B;

assign zext_ln17_fu_188_p1 = R;
