...
unsigned char Cr( char llvm_cbe_R,  char llvm_cbe_G,  char llvm_cbe_B);
...
printf("\n\{ BEGIN @Cr\n");
if (AESL_DEBUG_TRACE)
printf("\n  %%or.cond4 = and i1 %%1, %%2, !dbg !2 for 0x%I64xth hint within @Cr  --> \n", ++aesl_llvm_cbe_or_2e_cond4_count);
...
llvm_cbe_tmp__14:
if (AESL_DEBUG_TRACE)
printf("\n  %%or.cond = and i1 %%4, %%5, !dbg !2 for 0x%I64xth hint within @Cr  --> \n", ++aesl_llvm_cbe_or_2e_cond_count);
...
llvm_cbe_tmp__16:
if (AESL_DEBUG_TRACE)
printf("\n  %%or.cond3 = and i1 %%7, %%8, !dbg !2 for 0x%I64xth hint within @Cr  --> \n", ++aesl_llvm_cbe_or_2e_cond3_count);
...
printf("\nor.cond3 = 0x%X\n", llvm_cbe_or_2e_cond3);
  if (llvm_cbe_or_2e_cond3) {
    llvm_cbe_storemerge__PHI_TEMPORARY = (unsigned char )((unsigned char )123);   /* for PHI node */
...
llvm_cbe_tmp__15:
if (AESL_DEBUG_TRACE)
printf("\n  %%10 = zext i8 %%R to i32, !dbg !2 for 0x%I64xth hint within @Cr  --> \n", ++aesl_llvm_cbe_24_count);
  llvm_cbe_tmp__1 = (unsigned int )((unsigned int )(unsigned char )llvm_cbe_R&255U);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__1);
if (AESL_DEBUG_TRACE)
printf("\n  %%11 = sitofp i32 %%10 to double, !dbg !2 for 0x%I64xth hint within @Cr  --> \n", ++aesl_llvm_cbe_25_count);
  llvm_cbe_tmp__2 = (double )((double )(signed int )llvm_cbe_tmp__1);
if (AESL_DEBUG_TRACE)
printf("\n = %lf,  0x%llx\n", llvm_cbe_tmp__2, *(long long*)(&llvm_cbe_tmp__2));
if (AESL_DEBUG_TRACE)
printf("\n  %%12 = fmul double %%11, 4.390000e-01, !dbg !2 for 0x%I64xth hint within @Cr  --> \n", ++aesl_llvm_cbe_26_count);
  llvm_cbe_tmp__3 = (double )llvm_cbe_tmp__2 * 0x1.c189374bc6a7fp-2;
if (AESL_DEBUG_TRACE)
printf("\n = %lf,  0x%llx\n", llvm_cbe_tmp__3, *(long long*)(&llvm_cbe_tmp__3));
if (AESL_DEBUG_TRACE)
printf("\n  %%13 = zext i8 %%G to i32, !dbg !2 for 0x%I64xth hint within @Cr  --> \n", ++aesl_llvm_cbe_27_count);
  llvm_cbe_tmp__4 = (unsigned int )((unsigned int )(unsigned char )llvm_cbe_G&255U);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__4);
if (AESL_DEBUG_TRACE)
printf("\n  %%14 = sitofp i32 %%13 to double, !dbg !2 for 0x%I64xth hint within @Cr  --> \n", ++aesl_llvm_cbe_28_count);
  llvm_cbe_tmp__5 = (double )((double )(signed int )llvm_cbe_tmp__4);
if (AESL_DEBUG_TRACE)
printf("\n = %lf,  0x%llx\n", llvm_cbe_tmp__5, *(long long*)(&llvm_cbe_tmp__5));
if (AESL_DEBUG_TRACE)
printf("\n  %%15 = fmul double %%14, 3.680000e-01, !dbg !2 for 0x%I64xth hint within @Cr  --> \n", ++aesl_llvm_cbe_29_count);
  llvm_cbe_tmp__6 = (double )llvm_cbe_tmp__5 * 0x1.78d4fdf3b645ap-2;
if (AESL_DEBUG_TRACE)
printf("\n = %lf,  0x%llx\n", llvm_cbe_tmp__6, *(long long*)(&llvm_cbe_tmp__6));
if (AESL_DEBUG_TRACE)
printf("\n  %%16 = fsub double %%12, %%15, !dbg !2 for 0x%I64xth hint within @Cr  --> \n", ++aesl_llvm_cbe_30_count);
  llvm_cbe_tmp__7 = (double )llvm_cbe_tmp__3 - llvm_cbe_tmp__6;
if (AESL_DEBUG_TRACE)
printf("\n = %lf,  0x%llx\n", llvm_cbe_tmp__7, *(long long*)(&llvm_cbe_tmp__7));
if (AESL_DEBUG_TRACE)
printf("\n  %%17 = zext i8 %%B to i32, !dbg !2 for 0x%I64xth hint within @Cr  --> \n", ++aesl_llvm_cbe_31_count);
  llvm_cbe_tmp__8 = (unsigned int )((unsigned int )(unsigned char )llvm_cbe_B&255U);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__8);
if (AESL_DEBUG_TRACE)
printf("\n  %%18 = sitofp i32 %%17 to double, !dbg !2 for 0x%I64xth hint within @Cr  --> \n", ++aesl_llvm_cbe_32_count);
  llvm_cbe_tmp__9 = (double )((double )(signed int )llvm_cbe_tmp__8);
if (AESL_DEBUG_TRACE)
printf("\n = %lf,  0x%llx\n", llvm_cbe_tmp__9, *(long long*)(&llvm_cbe_tmp__9));
if (AESL_DEBUG_TRACE)
printf("\n  %%19 = fmul double %%18, 7.100000e-02, !dbg !2 for 0x%I64xth hint within @Cr  --> \n", ++aesl_llvm_cbe_33_count);
  llvm_cbe_tmp__10 = (double )llvm_cbe_tmp__9 * 0x1.22d0e56041893p-4;
if (AESL_DEBUG_TRACE)
printf("\n = %lf,  0x%llx\n", llvm_cbe_tmp__10, *(long long*)(&llvm_cbe_tmp__10));
if (AESL_DEBUG_TRACE)
printf("\n  %%20 = fsub double %%16, %%19, !dbg !2 for 0x%I64xth hint within @Cr  --> \n", ++aesl_llvm_cbe_34_count);
  llvm_cbe_tmp__11 = (double )llvm_cbe_tmp__7 - llvm_cbe_tmp__10;
if (AESL_DEBUG_TRACE)
printf("\n = %lf,  0x%llx\n", llvm_cbe_tmp__11, *(long long*)(&llvm_cbe_tmp__11));
if (AESL_DEBUG_TRACE)
printf("\n  %%21 = fadd double %%20, 1.280000e+02, !dbg !2 for 0x%I64xth hint within @Cr  --> \n", ++aesl_llvm_cbe_35_count);
  llvm_cbe_tmp__12 = (double )llvm_cbe_tmp__11 + 0x1p7;
if (AESL_DEBUG_TRACE)
printf("\n = %lf,  0x%llx\n", llvm_cbe_tmp__12, *(long long*)(&llvm_cbe_tmp__12));
if (AESL_DEBUG_TRACE)
printf("\n  %%22 = fptoui double %%21 to i8, !dbg !2 for 0x%I64xth hint within @Cr  --> \n", ++aesl_llvm_cbe_36_count);
