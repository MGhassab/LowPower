...
HD_PWD='C:/Users/ESRLab-04/Desktop/edgeDetection_2/edgeDetection_2/edgeDetection_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log accurate.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source accurate.tcl -notrace
