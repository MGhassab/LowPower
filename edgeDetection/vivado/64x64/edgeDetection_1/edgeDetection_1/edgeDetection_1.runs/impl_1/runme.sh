...
HD_PWD='C:/Users/ESRLab-04/Desktop/edgeDetection_1/edgeDetection_1/edgeDetection_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log memoization.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source memoization.tcl -notrace
