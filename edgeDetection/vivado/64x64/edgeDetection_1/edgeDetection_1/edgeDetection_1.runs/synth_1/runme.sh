...
HD_PWD='C:/Users/ESRLab-04/Desktop/edgeDetection_1/edgeDetection_1/edgeDetection_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log memoization.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source memoization.tcl
