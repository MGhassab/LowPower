...
`define AUTOTB_TVIN_in_r  "./c.sobel_filter.autotvin_in_r.dat"
`define AUTOTB_TVIN_out_r  "./c.sobel_filter.autotvin_out_r.dat"
`define AUTOTB_TVIN_in_r_out_wrapc  "./rtl.sobel_filter.autotvin_in_r.dat"
`define AUTOTB_TVIN_out_r_out_wrapc  "./rtl.sobel_filter.autotvin_out_r.dat"
`define AUTOTB_TVOUT_out_r  "./c.sobel_filter.autotvout_out_r.dat"
`define AUTOTB_TVOUT_out_r_out_wrapc  "./impl_rtl.sobel_filter.autotvout_out_r.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 1821721;
parameter LENGTH_in_r = 262144;
parameter LENGTH_out_r = 262144;
...
wire ap_idle;
wire ap_ready;
wire [17 : 0] in_r_address0;
wire  in_r_ce0;
wire [7 : 0] in_r_q0;
wire [17 : 0] in_r_address1;
wire  in_r_ce1;
wire [7 : 0] in_r_q1;
wire [17 : 0] out_r_address0;
wire  out_r_ce0;
wire  out_r_we0;
wire [7 : 0] out_r_d0;
integer done_cnt = 0;
...
wire    [17 : 0]    arrayin_r_address0, arrayin_r_address1;
...
assign arrayin_r_address1 = in_r_address1;
assign arrayin_r_ce1 = in_r_ce1;
assign in_r_q1 = arrayin_r_dout1;
...
wire    [17 : 0]    arrayout_r_address0, arrayout_r_address1;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.sobel_filter.autotvout_out_r.dat", "r");
    fp2 = $fopen("./impl_rtl.sobel_filter.autotvout_out_r.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.sobel_filter.autotvout_out_r.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.sobel_filter.autotvout_out_r.dat\"!");
    else begin
        $display("Comparing rtl.sobel_filter.autotvout_out_r.dat with impl_rtl.sobel_filter.autotvout_out_r.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
